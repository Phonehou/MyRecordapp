...
public class MainActivity extends BaseChatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent2 = new Intent(MainActivity.this, FileManageActivity.class); //跳转到文件管理界面
            startActivity(intent2);
        } else if (id == R.id.nav_slideshow) {
            Intent intent3 = new Intent(MainActivity.this, RecordActivity.class); //跳转到录音界面
            startActivity(intent3);
        } else if (id == R.id.nav_setting) {
            Intent intent4 = new Intent(MainActivity.this, SettingActivity.class); //跳转到设置界面
